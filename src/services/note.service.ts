import { Note, NotePage, NoteUpsertRequest } from '@/types/note.type'
import apiClient from '@/apis/api-client'
import { ApiResponse } from '@/types/auth.type'

const NOTE_BASE_API = '/documents/notes'

export const createNote = async (request: NoteUpsertRequest): Promise<Note> => {
...
export const updateNote = async (id: number, request: NoteUpsertRequest): Promise<Note> => {
