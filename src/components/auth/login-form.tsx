          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div className='space-y-2 flex flex-col'>
              ...
              <input
                ...
                className='w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200'
                required
              />
            </div>
            {/* End - Email Field */}
            ...
            <div className='text-center'>
              <p className='text-sm text-gray-600 dark:text-gray-400'>
                ...
                <Link href='/register' className='ml-2 text-blue-600 hover:text-blue-700 font-medium'>
                  Sign Up
                </Link>
              </p>
            </div>
